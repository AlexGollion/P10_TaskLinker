 ...
 */
final class Version20250319093858 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task ADD project_id INT NOT NULL, ADD employee_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task DROP project_id, DROP employee_id');
    }
}
